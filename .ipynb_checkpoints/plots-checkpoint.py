...
def export_results_table(master, path="results_table.csv", round_digits=4):
    """
    Rounds numeric columns for readability and writes a clean CSV. Not a
    figure -- this is the "Table 1" for your write-up, meant to be pasted
    into Word/LaTeX directly rather than screenshotted from a dataframe.
    """
    out = master.copy()
